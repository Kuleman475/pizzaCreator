...
import SavedPizza from './savedPizza'; // Make sure this exists!
...
function PizzaMaker({ navigation }) {
  ...
  const toppingsOptions = [
    ...
    "Hamburger", "Pickles", "Mac and Cheese", "Peanut Butter", "Jelly", "Doritos"
  ];
  ...
  const submitOrder = async () => {
    ...
    try {
      ...
      if (recipes.length >= 30) {
        Alert.alert("Too Many Pizzas", "You can only save up to 30 pizzas.");
        return;
      }
      ...
      console.error(err);
      Alert.alert("Error", "Something went wrong saving your pizza.");
    }
  };
  ...
  return (
    <ScrollView contentContainerStyle={styles.scrollContainer}>
      <View style={styles.container}>
        ...
        <Pressable onPress={() => navigation.navigate("SavedPizza")} style={[styles.submit, { backgroundColor: '#333' }]}>
...
// import { NavigationContainer } from '@react-navigation/native';
// import { createNativeStackNavigator } from '@react-navigation/native-stack';
// import SavedPizza from './savedPizza'; // adjust path if needed
...
//   const toppingsOptions = [
//     "Pepperoni", "Sausage", "Chicken", "Ham",
//     "Turkey","Green Peppers", "Red Peppers",
//     "Onions", "Olives", "Pineapple", "Mushrooms",
//     "Bacon", "Anchovies", "Corn", "Hamburger", "Pickles",
//     "Mac and Cheese", "Peanut Butter", "Jelly", "Doritos",
//   ];
...
//     await AsyncStorage.setItem('pizzaRecipe', JSON.stringify(recipe));
...
// {toppingsOptions.map((toppingsOptions) => (
//   <Pressable
//     key={toppingsOptions}
//     onPress={() => toggleToppings(toppingsOptions)}
//     style={[
//       styles.button,
//       toppings.includes(toppingsOptions) && styles.buttonClicked,
//     ]}
//   >
//     <Text style={styles.buttonLabel}>{toppingsOptions}</Text>
//   </Pressable>
//   ))}
//   </View>
...
//     <NavigationContainer>
//       <Stack.Navigator initialRouteName="PizzaMaker">
//         <Stack.Screen name="PizzaMaker" component={App} />
//         <Stack.Screen name="SavedPizza" component={SavedPizza} />
//       </Stack.Navigator>
//     </NavigationContainer>
// }